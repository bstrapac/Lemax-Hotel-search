...
You are not required to use any persistent storage (database or similar), but the design of the application should enable easy addition of the persistence layer afterwards. You’ll score bonus points if the search interface supports paging.
...
Be sure to submit your solution before the agreed deadline. Submit it in any form you think is most appropriate. We’ll evaluate the solution based on the following criteria:
